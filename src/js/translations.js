...
<p>L'indice di qualità dell'aria (AQI) è calcolato secondo le raccomandazioni della United States Environmental Protection Agency. Ulteriori informazioni sono disponibili sulla pagina ufficiale.(<a href='https://www.airnow.gov/aqi/aqi-basics/'>Link</a>). Passare il cursore sulla scala AQI per visualizzare i livelli di preoccupazione per la salute.</p>",
  ...
  'Donate for Sensor.Community (Hardware, Software) now on Betterplace.org': {
    de:
      "Jetzt spenden für 'Sensor.Community' (Hardware, Software) auf betterplace.org!",
    ...
    it:
      "Dona ora al 'Sensor.Community' (Hardware, Software) presso betterplace.org!",
  },
  'Donate for<br/>Sensor.Community<br/>now on<br/><span>Betterplace.org</span>': {
    de:
      'Jetzt für<br/>Sensor.Community<br/>spenden auf<br/><span>Betterplace.org</span>',
    nl:
      'Doneer vor<br/>Sensor.Community<br/>op<br/><span>Betterplace.org</span>',
    bg:
      'Дарете за<br/>Sensor.community<br/>на<br/><span>betterplace.org</span>',
    ru:
      'Поддержите проект<br/>Sensor.Community<br/>на<br/><span>Betterplace.org</span>',
    fr:
      'Faire un don pour<br/>Sensor.community<br/>sur<br/><span>Betterplace.org</span>',
    it:
      'Dona al<br/>Sensor.Community<br/>ora presso<br/><br/><span>Betterplace.org</span>.',
  },
}
